...
if [ ${model_name} == "Qwen3-30B-A3B-250425" ]; then
    ...
    #quant_file_path="cal_qwen3_30B_8b_g3/qwen3-30b-a3b/maxabs_quant_g3.json"
    quant_file_path="/software/users/mrezavan/vllm-hpu-extension/calibration/qwen3-30B-A3B-g3/qwen3-30b-a3b/maxabs_quant_g3.json"
...
ep_size=${tp_parallel}         # Expert parallelism size
...
for VLLM_FP32_SOFTMAX in 0; do # 0 1; do
